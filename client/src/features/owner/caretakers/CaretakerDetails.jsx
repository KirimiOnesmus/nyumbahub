...
const CaretakerDetails = () => {
  ...
  const startEditing = () => {
    setEditValues({ name: caretaker.name, phone: caretaker.phone, email: caretaker.email ?? '' });
    setEditErrors({});
    setEditError(null);
    setIsEditing(true);
  };
    ...
    <div className="flex flex-col gap-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="edit-phone" className={labelClasses}>
                      Phone Number <span className="text-slate-400 normal-case font-normal">(not editable)</span>
                    </label>
                    <input
                      id="edit-phone"
                      type="tel"
      ...
      {showAssignModal && caretaker && (
        <AssignCaretaker
          ...
          onSaved={handleBuildingAssigned}
        />
      )}
    </div>
  );
